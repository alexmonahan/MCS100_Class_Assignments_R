...
data = read.csv('NCAAfootball2014.csv')
...
nonFBS = names(games)[games < 10]

# Next, replace each non-FBS team with the character string "nonFBS".

home[is.element(home, nonFBS)] = 'nonFBS'
away[is.element(away, nonFBS)] = 'nonFBS'
